...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "OBSR-seeder\n"
...
static const string mainnet_seeds[] = {"main1.seeder.obsr.org", "main2.seeder.obsr.org", ""};
...
extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("obsreqzk4zwi5zd3.onion", 9567), true);
  }
  do {
